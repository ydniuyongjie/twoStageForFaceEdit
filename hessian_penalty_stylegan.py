...
def main():
    ...
    experiment_name="Hessian_{}_{}".format(args.gan_type,args.batch_size)
    ...
    torch.save(D.state_dict(), osp.join(models_dir, 'deformator_init.pt'))
    ...
    try:
        shutil.copytree(src=wip_dir, dst=complete_dir, ignore=shutil.ignore_patterns('checkpoint.pt'))
        print("  \\__Done!")
    except IOError as e:
        print("  \\__Already exists -- {}".format(e))
